...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\PROYEK\SIAKAD\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\PROYEK\\SIAKAD\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'login','login.process','logout',
'akademik.dashboard','semester.index','semester.create','semester.store','semester.edit',
'semester.update','semester.destroy','input-nilai.index','input-nilai.create','input-nilai.store',
'input-nilai.edit','input-nilai.update','input-nilai.destroy','matakuliah.index','matakuliah.create',
'matakuliah.store','matakuliah.edit','matakuliah.update','matakuliah.destroy','ruang.index',
'ruang.create','ruang.store','ruang.edit','ruang.update','ruang.destroy',
'jadwalkuliah.index','jadwalkuliah.create','jadwalkuliah.store','jadwalkuliah.edit','jadwalkuliah.update',
'jadwalkuliah.destroy','generate.jadwal.smart','notification.delete','ruang.import','jadwalkuliah.export.excel',
'jadwal.pdf.all','jadwalkuliah.kirim.warek','jadwalkuliah.distribusikan','warek1.dashboard',
'warek1.jadwal.index','warek1.jadwal.setujui','warek1.jadwal.revisi','warek1.jadwal.setujui.bulk','warek1.jadwal.setujui.semua',
'dekan.dashboard','dekan/jadwalkuliah','kaprodi.dashboard','kurikulum.index','kurikulum.create',
'kurikulum.store','kurikulum.edit','kurikulum.update','kurikulum.destroy','matakuliah.index',
'matakuliah.create','matakuliah.store','matakuliah.edit','matakuliah.update','matakuliah.destroy',
'plotingdosen.index','plotingdosen.create','plotingdosen.store','plotingdosen.edit','plotingdosen.update',
'plotingdosen.destroy','kaprodi.jadwalkuliah.index','dosen.dashboard','inputnilaimahasiswa.index','inputnilaimahasiswa.create',
'inputnilaimahasiswa.store','inputnilaimahasiswa.edit','inputnilaimahasiswa.update','dosen.jadwalkuliah','nilai.import',
'notification.delete','mahasiswa.dashboard','mahasiswa.jadwalkuliah','storage.local',);
        registerArgumentsSet('views', 
'akademik.Dashboard.index','akademik.Jadwalkuliah.create','akademik.Jadwalkuliah.edit','akademik.Jadwalkuliah.index','akademik.Jadwalkuliah.pdf',
'akademik.Semester.Create','akademik.Semester.edit','akademik.Semester.index','akademik.input-nilai.create','akademik.input-nilai.edit',
'akademik.input-nilai.index','akademik.matakuliah.Create','akademik.matakuliah.edit','akademik.matakuliah.index','akademik.ruang.Create',
'akademik.ruang.edit','akademik.ruang.index','dekan.Dashboard.index','dekan.jadwalkuliah.index','dosen.Dashboard.index',
'dosen.JadwalKuliah.index','dosen.inputnilai.index','kaprodi.Dashboard.index','kaprodi.Kurikulum.Create','kaprodi.Kurikulum.edit',
'kaprodi.Kurikulum.index','kaprodi.jadwalkuliah.index','kaprodi.matakuliah.create','kaprodi.matakuliah.edit','kaprodi.matakuliah.index',
'kaprodi.plotingdosen.create','kaprodi.plotingdosen.edit','kaprodi.plotingdosen.index','layouts.footer','layouts.head',
'layouts.header','layouts.main','layouts.sidebar.akademik','layouts.sidebar.dekan','layouts.sidebar.dosen',
'layouts.sidebar.kaprodi','layouts.sidebar.mahasiswa','layouts.sidebar.warek1','login','mahasiswa.dashboard.index',
'mahasiswa.jadwalkuliah.create','mahasiswa.jadwalkuliah.edit','mahasiswa.jadwalkuliah.index','mahasiswa.jadwalkuliah.pdf','warek1.Dashboard.index',
'warek1.jadwal.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.PROYEK.SIAKAD.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);

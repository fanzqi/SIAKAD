...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Kurikulum</a></li>
        </ol>
    </div>
</div>
                ...
                <form action="{{ route('kurikulum.update', $kurikulum->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_mk" id="kode_mk"
                            ...
                            value="{{ old('kode_mk', $kurikulum->kode_mk) }}" required>
                        @error('kode_mk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_mk" id="nama_mk"
                            ...
                            value="{{ old('nama_mk', $kurikulum->nama_mk) }}" required>
                        @error('nama_mk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="sks" id="sks"
                            ...
                            value="{{ old('sks', $kurikulum->sks) }}" required>
                        @error('sks')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Mata Kuliah</a></li>
        </ol>
    </div>
</div>
...
<div class="container mt-4">
    ...
    <form action="{{ route('matakuliah.update', $data->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="fakultas" name="fakultas" value="{{ $data->fakultas }}" required>
        </div>
        <div class="form-group">
            <label for="program_studi">Program Studi</label>
            <input type="text" class="form-control" id="program_studi" name="program_studi" value="{{ $data->program_studi }}" required>
        </div>
        <div class="form-group">

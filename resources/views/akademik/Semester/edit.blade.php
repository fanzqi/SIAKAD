                        ...
                        <form action="{{ route('semester.update', $semester->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="tahun_akademik"
                                    ...
                                    value="{{ old('tahun_akademik', $semester->tahun_akademik) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="kode_semester"
                                    ...
                                    value="{{ old('kode_semester', $semester->kode_semester) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="semester" class="form-control @error('semester') is-invalid @enderror">
                                    ...
                                    <option value="Ganjil"
                                        {{ old('semester', $semester->semester) == 'Ganjil' ? 'selected' : '' }}>Ganjil
                                    </option>
                                    <option value="Genap"
                                        {{ old('semester', $semester->semester) == 'Genap' ? 'selected' : '' }}>Genap
                                    </option>
                                    <option value="Pendek"
                                        {{ old('semester', $semester->semester) == 'Pendek' ? 'selected' : '' }}>Pendek
                                    </option>
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="periode_mulai"
                                    ...
                                    value="{{ old('periode_mulai', $semester->periode_mulai) }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="periode_selesai"
                                    ...
                                    value="{{ old('periode_selesai', $semester->periode_selesai) }}">
